...
//Move data outside to avoid unnecessary re-rendering
const BASE_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'Build cross-platform mobile apps with React Native. Learn state management, navigation, and deployment.',
  ...
  },
  {
    ...
    description: 'Master modern UI/UX design principles, tools, and techniques for creating stunning user interfaces.',
    category: 'Design',
...
// Static data arrays - moved outside function
const COURSE_NAMES = [
...
const generateProducts = (): Product[] => {
  ...
  for (let i = 9; i <= 60; i++) {
    const courseNameIndex = (i - 9) % COURSE_NAMES.length;
    const instructorIndex = (i - 9) % INSTRUCTORS.length;
    const courseName = COURSE_NAMES[courseNameIndex];
  ...
  return [...BASE_PRODUCTS, ...additionalProducts];
};
